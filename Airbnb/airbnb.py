...
if SELECT == "Home":
    ...
    with col2:
        ...
        st.markdown("[Githublink](https://github.com/Mithun250/Airbnb_Analysis)")
    st.write("---")  
...
if SELECT == "Explore Data":
    ...
    if fl is not None:
        ...
        os.chdir(r"C:\Users\91915\OneDrive\Desktop\Airbnb")
    ...
    with col1:
        ...
        fig = px.bar(
            ...
            x="room_type",
            y="price",
            text=['${:,.2f}'.format(x) for x in room_type_df["price"]],
            template="seaborn"
        )
    ...
    with cl2:
        with st.expander("Neighbourhood Group Wise Price"):
            ...
            st.download_button(
                "Download Data",
                data=csv,
                file_name="neighbourhood_group.csv",
                mime="text/csv",
                help='Click here to download the data as a CSV file'
            )
    ...
    data1['layout'].update(
        title="Room Type in the Neighbourhood and Neighbourhood Group Wise Data Using Scatter Plot.",
    ...
    st.subheader("Number of Listings of Each Room Type in the Neighborhoods (Map View)")
    ...
    fig = px.scatter_mapbox(df, 
                            ...
                            title="Number of Listings by Room Type in Neighborhoods"
                            )
